...
public class AddCustomerPage extends BasePage{
	...
	@FindBy(how = How.XPATH,using = "//*[@id=\"cid\"]") WebElement COMPANY_DPDOWN_ELEMENT;
	@FindBy(how = How.XPATH,using = "//*[@id=\"email\"]")WebElement EMAIL_ELEMENT;
	
	
	public void validateAddCustomerPage(String expectedText) {
		
		validateElement(ADD_CUSTOMER_HEADER_ELEMENT.getText(),expectedText, "Add Customer page not available");
	}
	public void insertFullName(String fullName) {
		FULL_NAME_ELEMENT.sendKeys(fullName + randomNumGenerator(999));
	}
	public void selectCompanyName(String company) {
		selectFromDropDown(COMPANY_DPDOWN_ELEMENT, company);			
	}
